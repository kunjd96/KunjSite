    ...
    data: [
        {
            ...
            allprojects: [
                    ...
                    features: [
                        {
                            ...
                            type: "mobile",
                            description: "Registered users can punch in and punch out with the application, which in return gives users a specific and accurate total time for the duration the user has been working."
                        },
                        {
                            title: "Add More Than One Job",
                        ...
                        },
                        {
                            ...
                            type: "mobile",
                            description: "Monthly accurate salary reports are generated to users for the jobs which they have been working on. Registered users can retrieve any salary logs for any specific mentioned period at any time."
                        },
                        {
                ...
                },
                {
                    ...
                    features: [
                        ...
                        },
                        {
                            ...
                            type: "mobile",
                            description: "The allocation of time required to complete the job is given to the clients after analyzing the problem by the service providers."
                        },
                        {
                ...
                },
                {
                    ...
                    liveUrl: "https://tec-galaxy.web.app/Dashboard/home",
                    description: 'This website is a basic e-commerce website to sell hardware technical components. Users can get registered and customize their machine within the website, which can get delivered to their doorsteps. This e-commerce website has all the basic features which any e-commerce website can have such as filters through products, a search bar, add to cart, etc. Some of the major features are as followed.',
                    technologies: [
                        {
                            name: "Angular",
                    ...
                    features: [
                        {
                            ...
                            type: "web",
                            description: "If users do not have any knowledge regarding which machine to buy, All they need to do is simply fill out one easy AI form which can lead them to the list of machines/hardware they are probably going to need. They can purchase any of the hardware within the list directly."
                        },
                        {
                            title: "Assembly",
                            mockupurl: "../../assets/img/tec3 (2).png",
                            type: "web",
                            description: "If users need their machine to have specific features per component, they can get this done using the assembly feature of the website, this feature allows users to choose from a variety of components of the specific machine/hardware they asked for. They can choose each of the components separately and make their machine as they required."
                        },
                        {
                            title: "Admin control",
            ...
            allprojects: [
                {
                    ...
                    liveUrl: "https://linkshare1218.firebaseapp.com/#/login",
                    description: 'This website is useful to store and share links privately as well as publicly within the website i.e. website has private and public lockers to store the links. The features of the website are as followed.',
                    technologies: [
                        {
                            name: "Angular",
                            valueIcon: "devicon-angularjs-plain"
            ...
            allprojects: [
                {
                    ...
                    liveUrl: "",
                    description: 'The whole idea of this application is focused to have all the necessary documents in a single place. This application is to store and retrieve any medical or government documents easily within a single QR code scan. The features are as followed',
                    technologies: [
                        {
                            name: "Android",
                            valueIcon: "devicon-android-plain"
                    ...
                    features: [
                        {
                            ...
                            type: "web",
                            description: "The single QR code scan with our QR code scanner within the application will allow users i.e. doctors to have all their medical data at a single scan."
                        },
                        {
...
function SingleProjectComponent_div_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SingleProjectComponent_div_9_Template_i_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.couterplus(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const technologies_r3 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassMapInterpolate1"]("", technologies_r3.valueIcon, " colored  iconcss");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("title", technologies_r3.name);
} }
function SingleProjectComponent_a_11_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("href", ctx_r1.ProjectData.liveUrl, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
} }
function SingleProjectComponent_div_12_div_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div");
} }
function SingleProjectComponent_div_12_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 22);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("src", feature_r6.mockupurl, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", feature_r6.type == "web" ? "featuresimageweb" : "featuresimage");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", feature_r6.title, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", feature_r6.description, " ");
} }
function SingleProjectComponent_div_12_ng_template_4_Template(rf, ctx) { if (rf & 1) {
...
function SingleProjectComponent_div_12_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, SingleProjectComponent_div_12_div_1_Template, 1, 0, "div", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, SingleProjectComponent_div_12_ng_template_2_Template, 7, 4, "ng-template", null, 20, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, SingleProjectComponent_div_12_ng_template_4_Template, 7, 4, "ng-template", null, 21, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplateRefExtractor"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](4, _c0, feature_r6.type === "web"));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", i_r7 % 2 == 0)("ngIfThen", _r9)("ngIfElse", _r11);
} }
...
SingleProjectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SingleProjectComponent, selectors: [["app-single-project"]], decls: 21, vars: 6, consts: [[1, "maincontent"], [1, "row", "row-no-margin", "row_100"], [1, "col-md-12", "imagbox"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn ", 1, "imgfacepic", 3, "src"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn animate__delay-1s", 1, "h1style", "margin_top_2", "sizecss2"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn animate__delay-1s", 1, "ptagtitledescription"], [1, "plateformlist"], ["class", "platformcss", 4, "ngFor", "ngForOf"], [1, "platformcss"], ["target", "_blank", 3, "href", 4, "ngIf"], ["class", "row row-no-margin", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "contactmefelxdiv", "card"], [1, "contactchilddiv"], [1, "psize", 2, "padding", "0%", "margin-top", "10px"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn", 1, "raise", "margin_top_5", "contactmebtn", 3, "click"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn animate__delay-1s", 3, "title", "click"], ["target", "_blank", 3, "href"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__zoomIn", "title", "Live", 1, "material-icons-outlined", "md-32", "iconcss", "iconcolor", "hide-on-init"], [1, "row", "row-no-margin", 3, "ngClass"], [4, "ngIf", "ngIfThen", "ngIfElse"], ["leftside", ""], ["rightside", ""], [1, "col-md-6", "featuresimagesdiv"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInLeftBig", 1, "hide-on-init", 3, "ngClass", "src"], [1, "col-md-6", "featuresContentdiv"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInRightBig", 1, "h1style", "margin_top_2", "featuretitle", "hide-on-init"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInRightBig", 1, "featureContentDescription", "hide-on-init"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInLeftBig", 1, "h1style", "margin_top_2", "featuretitle", "hide-on-init"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInLeftBig", 1, "featureContentDescription", "hide-on-init"], ["animateOnScroll", "", "animationName", "animated animate__animated animate__fadeInRightBig", 1, "hide-on-init", 3, "ngClass", "src"]], template: function SingleProjectComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](3, "img", 3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](11, SingleProjectComponent_a_11_Template, 3, 1, "a", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](12, SingleProjectComponent_div_12_Template, 6, 6, "div", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](13, "hr");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](14, "div", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "div", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "p", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](17, " Enough about this project now let's talk about yours. ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](18, "div", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](19, "button", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SingleProjectComponent_Template_button_click_19_listener() { return ctx.gotoconatctme("Conatct"); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.counter >= 2 && ctx.ProjectData.liveUrl != "");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.ProjectData.features);
    } }, directives: [ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_4__["AnimateOnScrollDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgClass"]], styles: ["@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans&display=swap\");\n@import url(\"https://fonts.googleapis.com/css2?family=Quantico:ital,wght@1,700&display=swap\");\n.h1style[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  margin: 0% !important;\n  font-family: \"Quantico\";\n}\n.maincontent[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  top: 64px;\n  bottom: 0%;\n}\n.animated[_ngcontent-%COMP%] {\n  visibility: visible !important;\n}\n.hide-on-init[_ngcontent-%COMP%] {\n  visibility: hidden;\n}\n.row-no-margin[_ngcontent-%COMP%] {\n  width: 100%;\n  margin-left: 0px !important;\n  margin-right: 0px !important;\n}\n.row-no-margin2[_ngcontent-%COMP%] {\n  width: 100%;\n  margin-left: 25px !important;\n  margin-right: 25px !important;\n}\n.imgfacepic[_ngcontent-%COMP%] {\n  width: 150px;\n}\n.iconcolor[_ngcontent-%COMP%] {\n  color: white;\n}\n.raise[_ngcontent-%COMP%]:hover, .raise[_ngcontent-%COMP%]:focus {\n  box-shadow: 0 0.7em 0.7em -0.4em #B80F0A;\n  transform: translateY(-0.25em);\n}\n.margin_top_5[_ngcontent-%COMP%] {\n  margin-top: 5% !important;\n}\n.contactmebtn[_ngcontent-%COMP%] {\n  color: #B80F0A;\n  background-color: transparent;\n  font-size: 15px;\n  font-family: \"Open Sans\";\n  border: 1px solid #B80F0A;\n  font-family: \"Quantico\";\n  padding: 8px;\n  padding-right: 25px;\n  padding-left: 25px;\n}\n.contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n  border-color: #B80F0A;\n  color: #B80F0A;\n}\n.card[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  font-size: 18px;\n  background: rgba(255, 255, 255, 0.1);\n  box-shadow: 0 8px 32px 0 rgba(16, 54, 32, 0.37);\n  border-right: 1px solid rgba(255, 255, 255, 0.2);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.2);\n  -webkit-backdrop-filter: blur(10px);\n          backdrop-filter: blur(10px);\n  transition: 2s ease;\n  animation: bounce-in 1.5s linear;\n  padding: 15px;\n}\n.margin_top_5[_ngcontent-%COMP%] {\n  margin-top: 5% !important;\n}\n.featuresimagesdiv[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  height: 100%;\n}\n.featuresContentdiv[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.featuresimage[_ngcontent-%COMP%] {\n  width: 325px;\n  max-width: 100%;\n}\n.featuresimageweb[_ngcontent-%COMP%] {\n  margin-top: 3%;\n  width: 600px;\n  min-height: 400px;\n  max-width: 100%;\n}\n.margin_top_2[_ngcontent-%COMP%] {\n  margin-top: 2% !important;\n}\n.aboutsectiontextdiv[_ngcontent-%COMP%] {\n  width: 80%;\n}\n.row_100[_ngcontent-%COMP%] {\n  height: 100%;\n}\n.imagbox[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.aboutmesection[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  color: #FFFFFF;\n}\n.featureContentDescription[_ngcontent-%COMP%] {\n  color: #676767;\n  font-family: #FFFFFF;\n  text-align: center;\n  width: 90%;\n  margin-top: 20px;\n  font-size: 18px;\n}\n.contactchilddiv[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: ro;\n}\n.contactmefelxdiv[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  column-gap: 25px;\n}\n.card_box[_ngcontent-%COMP%] {\n  border-radius: 10px;\n  padding: 5%;\n  background: rgba(255, 255, 255, 0.1);\n  box-shadow: 0 5px 5px 0 rgba(103, 119, 109, 0.37);\n  transition: 2s ease;\n}\n.ptagtitledescription[_ngcontent-%COMP%] {\n  color: #676767;\n  font-family: #FFFFFF;\n  width: 60%;\n  text-align: center;\n  margin-top: 60px;\n  margin-bottom: 25px;\n  font-size: 18px;\n}\n.aboutsectiontextdiv[_ngcontent-%COMP%] {\n  width: 80%;\n}\n.plateformlist[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n}\n.platformcss[_ngcontent-%COMP%]:hover {\n  \n  \n  transform: scale(1.5);\n}\n.platformcss[_ngcontent-%COMP%] {\n  padding-top: 10px;\n  padding-bottom: 10px;\n  color: #676767;\n  padding-left: 15px;\n  transition: transform 0.2s ease;\n}\n.iconcss[_ngcontent-%COMP%] {\n  font-size: 25px;\n  align-items: center;\n  transition: transform 0.5s ease;\n  opacity: 0.5;\n}\n.featuretitle[_ngcontent-%COMP%] {\n  font-size: 20px !important;\n}\n.sizecss2[_ngcontent-%COMP%] {\n  font-size: 25px !important;\n}\n.psize[_ngcontent-%COMP%] {\n  font-size: 18px !important;\n}\n@media only screen and (max-width: 600px) {\n  .imgfacepic[_ngcontent-%COMP%] {\n    width: 100px;\n  }\n\n  .imagbox[_ngcontent-%COMP%] {\n    display: flex;\n    flex-direction: column;\n    justify-content: start;\n    padding-right: 0%;\n    padding-left: 0%;\n  }\n\n  .row-no-margin[_ngcontent-%COMP%] {\n    height: auto !important;\n    margin-left: 0px !important;\n    margin-right: 0px !important;\n  }\n\n  .aboutsectiontextdiv[_ngcontent-%COMP%] {\n    margin-top: 10%;\n    width: 95%;\n  }\n\n  .ptagtitledescription[_ngcontent-%COMP%] {\n    color: #676767;\n    font-family: \"Quantico\";\n    width: 95%;\n    text-align: center;\n    margin-top: 30px;\n    margin-bottom: 25px;\n    font-size: 15px;\n  }\n\n  .featuresimage[_ngcontent-%COMP%] {\n    width: 225px;\n    max-width: 100%;\n  }\n\n  .featuresimageweb[_ngcontent-%COMP%] {\n    margin-top: 3%;\n    width: 400px;\n    min-height: 200px;\n    max-width: 100%;\n  }\n\n  .featuretitle[_ngcontent-%COMP%] {\n    font-size: 18px !important;\n  }\n\n  .featureContentDescription[_ngcontent-%COMP%] {\n    color: #676767;\n    font-family: #FFFFFF;\n    text-align: center;\n    width: 90%;\n    margin-top: 18px;\n    font-size: 16px;\n  }\n\n  .sizecss2[_ngcontent-%COMP%] {\n    font-size: 18px !important;\n  }\n\n  .psize[_ngcontent-%COMP%] {\n    font-size: 12px !important;\n  }\n\n  .contactmebtn[_ngcontent-%COMP%] {\n    color: #B80F0A;\n    background-color: transparent;\n    font-size: 12px;\n    font-family: \"Open Sans\";\n    border: 1px solid #B80F0A;\n    font-family: \"Quantico\";\n    padding: 6px;\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  .contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n    border-color: #B80F0A;\n    color: #B80F0A;\n  }\n}\n@media (min-width: 1000px) and (max-width: 1400px) {\n  .imgfacepic[_ngcontent-%COMP%] {\n    width: 100px;\n  }\n\n  .featuresimage[_ngcontent-%COMP%] {\n    width: 225px;\n    max-width: 100%;\n  }\n\n  .featuresimageweb[_ngcontent-%COMP%] {\n    margin-top: 3%;\n    width: 400px;\n    min-height: 200px;\n    max-width: 100%;\n  }\n\n  .psize[_ngcontent-%COMP%] {\n    font-size: 12px !important;\n  }\n\n  .featuretitle[_ngcontent-%COMP%] {\n    font-size: 18px !important;\n  }\n\n  .ptagtitledescription[_ngcontent-%COMP%] {\n    color: #676767;\n    font-family: \"Quantico\";\n    width: 80%;\n    text-align: center;\n    margin-top: 30px;\n    margin-bottom: 25px;\n    font-size: 16px;\n  }\n\n  .featureContentDescription[_ngcontent-%COMP%] {\n    color: #676767;\n    font-family: #FFFFFF;\n    text-align: center;\n    width: 90%;\n    margin-top: 18px;\n    font-size: 15px;\n  }\n\n  .sizecss2[_ngcontent-%COMP%] {\n    font-size: 18px !important;\n  }\n\n  .contactmebtn[_ngcontent-%COMP%] {\n    color: #B80F0A;\n    background-color: transparent;\n    font-size: 12px;\n    font-family: \"Open Sans\";\n    border: 1px solid #B80F0A;\n    font-family: \"Quantico\";\n    padding: 6px;\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  .contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n    border-color: #B80F0A;\n    color: #B80F0A;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
SidenavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SidenavComponent, selectors: [["app-sidenav"]], viewQuery: function SidenavComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_material_sidenav__WEBPACK_IMPORTED_MODULE_5__["MatDrawerContainer"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_5__["MatDrawer"], _toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_6__["ToolbarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"]], styles: ["@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans&display=swap\");\n@import url(\"https://fonts.googleapis.com/css2?family=Quantico:ital,wght@1,700&display=swap\");\nbody[_ngcontent-%COMP%] {\n  background-color: #101820FF !important;\n}\n.mainbox[_ngcontent-%COMP%] {\n  background-color: #101820FF;\n  height: 100vh;\n}\n.example-sidenav[_ngcontent-%COMP%] {\n  width: 8%;\n  background-color: #101820FF;\n  box-shadow: 2px 2px #000000;\n}\n.row-no-margin[_ngcontent-%COMP%] {\n  margin-left: 0px !important;\n  margin-right: 0px !important;\n}\n.flex-sidebar-parent[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  width: 100%;\n  color: #FFFFFF;\n}\n.cardicon[_ngcontent-%COMP%] {\n  background-color: #101820FF;\n  color: #FFFFFF;\n  display: flex;\n  margin-top: 20px;\n  width: 70%;\n  height: 10%;\n  box-shadow: 4px 4px #000000;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.flip-card[_ngcontent-%COMP%] {\n  background-color: transparent;\n  width: 70%;\n  height: 10%;\n  margin-top: 10%;\n  perspective: 1000px;\n}\n.animated[_ngcontent-%COMP%] {\n  visibility: visible !important;\n}\n.hide-on-init[_ngcontent-%COMP%] {\n  visibility: hidden;\n}\n.flip-card-inner[_ngcontent-%COMP%] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  text-align: center;\n  transition: transform 0.6s;\n  transform-style: preserve-3d;\n  box-shadow: 0 4px 8px 0 #000000;\n}\n.iconcolor[_ngcontent-%COMP%] {\n  color: #B80F0A;\n}\n.flip-card[_ngcontent-%COMP%]:hover   .flip-card-inner[_ngcontent-%COMP%] {\n  transform: rotateY(180deg);\n}\n.flip-card-front[_ngcontent-%COMP%], .flip-card-back[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  -webkit-backface-visibility: hidden;\n  backface-visibility: hidden;\n}\n.flip-card-front[_ngcontent-%COMP%] {\n  background-color: #101820FF;\n  color: #FFFFFF;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.flip-card-back[_ngcontent-%COMP%] {\n  background-color: #101820FF;\n  color: #FFFFFF;\n  display: flex;\n  border-bottom: 1px solid #B80F0A;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  transform: rotateY(180deg);\n}\n.fontsizesmall[_ngcontent-%COMP%] {\n  font-size: 15px;\n}\n@media only screen and (max-width: 600px) {\n  .example-sidenav[_ngcontent-%COMP%] {\n    width: 35%;\n    background-color: #101820FF;\n  }\n\n  .cardicon[_ngcontent-%COMP%] {\n    width: 90%;\n  }\n\n  .flip-card-inner[_ngcontent-%COMP%] {\n    transform: rotateY(180deg);\n  }\n\n  .iconcolor[_ngcontent-%COMP%] {\n    color: #FFFFFF;\n  }\n}\n@media only screen and (max-width: 1400px) {\n  .fontsizesmall[_ngcontent-%COMP%] {\n    font-size: 15px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"], data: { animation: [_shared_animations_slideanimation__WEBPACK_IMPORTED_MODULE_1__["slideInAnimation"]] } });
...
HomepageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomepageComponent, selectors: [["app-homepage"]], decls: 23, vars: 0, consts: [[1, "homecontent"], [1, "row", "row-no-margin"], [1, "col-md-6", "titleFlex"], [1, "haderdata"], [1, "h1style", "sizecss", "animate__animated", "animate__zoomIn"], [1, "h1style", "sizecss", "animate__animated", "animate__zoomIn", 2, "padding-top", "3%"], [1, "spancolor"], [1, "h1style", "sizecss2", "animate__animated", "animate__zoomIn"], [1, "title", "animate__animated", "animate__zoomIn", "bodycolor", 2, "padding-top", "2%"], ["animateOnScroll", "", "animationName", "animate__animated animate__zoomIn", 1, "raise", "margin_top_5", "contactmebtn", 3, "click"], [1, "col-md-6", "titleFlex2"], ["src", "../../assets/img/home3.png", 1, "animationimg"]], template: function HomepageComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_3__["AnimateOnScrollDirective"]], styles: ["@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans&display=swap\");\n@import url(\"https://fonts.googleapis.com/css2?family=Quantico:ital,wght@1,700&display=swap\");\n@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans&display=swap\");\n@import url(\"https://fonts.googleapis.com/css2?family=Quantico:ital,wght@1,700&display=swap\");\nbody[_ngcontent-%COMP%] {\n  background-color: #101820FF !important;\n}\n.mainbox[_ngcontent-%COMP%] {\n  background-color: #101820FF;\n  height: 100vh;\n}\n.h1style[_ngcontent-%COMP%] {\n  color: #FFFFFF;\n  margin: 0% !important;\n}\n.bodycolor[_ngcontent-%COMP%] {\n  color: #676767;\n  margin: 0% !important;\n}\n.homecontent[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  top: 64px;\n  bottom: 0%;\n}\n.animated[_ngcontent-%COMP%] {\n  visibility: visible !important;\n}\n.hide-on-init[_ngcontent-%COMP%] {\n  visibility: hidden;\n}\n.row-no-margin[_ngcontent-%COMP%] {\n  height: 100%;\n  margin-left: 0px !important;\n  margin-right: 0px !important;\n}\n.mat-display-1[_ngcontent-%COMP%] {\n  --animate-delay: 0.5s;\n}\n.titleFlex[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.titleFlex2[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.animationimg[_ngcontent-%COMP%] {\n  animation: upNdown 2s infinite linear;\n  width: 500px;\n}\n.raise[_ngcontent-%COMP%]:hover, .raise[_ngcontent-%COMP%]:focus {\n  box-shadow: 0 0.7em 0.7em -0.4em #B80F0A;\n  transform: translateY(-0.25em);\n}\n.margin_top_5[_ngcontent-%COMP%] {\n  margin-top: 5% !important;\n}\n.contactmebtn[_ngcontent-%COMP%] {\n  color: #B80F0A;\n  background-color: transparent;\n  font-size: 15px;\n  font-family: \"Open Sans\";\n  border: 1px solid #B80F0A;\n  font-family: \"Quantico\";\n  padding: 8px;\n  padding-right: 25px;\n  padding-left: 25px;\n}\n.contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n  border-color: #B80F0A;\n  color: #B80F0A;\n}\n.sizecss[_ngcontent-%COMP%] {\n  font-size: 45px !important;\n}\n.sizecss2[_ngcontent-%COMP%] {\n  font-size: 30px !important;\n}\n.title[_ngcontent-%COMP%] {\n  font-size: 20px !important;\n}\n.spancolor[_ngcontent-%COMP%] {\n  color: #B80F0A;\n}\n@keyframes upNdown {\n  50% {\n    transform: translateY(-20px);\n  }\n}\n.haderdata[_ngcontent-%COMP%] {\n  width: 70%;\n}\n@media only screen and (max-width: 600px) {\n  .sizecss[_ngcontent-%COMP%] {\n    font-size: 25px !important;\n  }\n\n  .sizecss2[_ngcontent-%COMP%] {\n    font-size: 15px !important;\n  }\n\n  .title[_ngcontent-%COMP%] {\n    font-size: 12px !important;\n  }\n\n  .raise[_ngcontent-%COMP%]:hover, .raise[_ngcontent-%COMP%]:focus {\n    box-shadow: 0 0.7em 0.7em -0.4em #B80F0A;\n    transform: translateY(-0.25em);\n  }\n\n  .margin_top_5[_ngcontent-%COMP%] {\n    margin-top: 5% !important;\n  }\n\n  .contactmebtn[_ngcontent-%COMP%] {\n    color: #B80F0A;\n    background-color: transparent;\n    font-size: 12px;\n    font-family: \"Open Sans\";\n    border: 1px solid #B80F0A;\n    font-family: \"Quantico\";\n    padding: 6px;\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  .contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n    border-color: #B80F0A;\n    color: #B80F0A;\n  }\n\n  .animationimg[_ngcontent-%COMP%] {\n    animation: upNdown 2s infinite linear;\n    max-width: 250px;\n  }\n}\n@media only screen and (max-width: 1400px) {\n  .sizecss[_ngcontent-%COMP%] {\n    font-size: 35px !important;\n  }\n\n  .sizecss2[_ngcontent-%COMP%] {\n    font-size: 20px !important;\n  }\n\n  .title[_ngcontent-%COMP%] {\n    font-size: 15px !important;\n  }\n\n  .raise[_ngcontent-%COMP%]:hover, .raise[_ngcontent-%COMP%]:focus {\n    box-shadow: 0 0.7em 0.7em -0.4em #B80F0A;\n    transform: translateY(-0.25em);\n  }\n\n  .margin_top_5[_ngcontent-%COMP%] {\n    margin-top: 5% !important;\n  }\n\n  .contactmebtn[_ngcontent-%COMP%] {\n    color: #B80F0A;\n    background-color: transparent;\n    font-size: 12px;\n    font-family: \"Open Sans\";\n    border: 1px solid #B80F0A;\n    font-family: \"Quantico\";\n    padding: 6px;\n    padding-right: 25px;\n    padding-left: 25px;\n  }\n  .contactmebtn[_ngcontent-%COMP%]:hover, .contactmebtn[_ngcontent-%COMP%]:focus {\n    border-color: #B80F0A;\n    color: #B80F0A;\n  }\n\n  .animationimg[_ngcontent-%COMP%] {\n    animation: upNdown 2s infinite linear;\n    width: 350px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
const AboutMe = {
    data: {
        title: '',
        endbody: 'Throughout these years I have tried my hand at resolving problems and improving customer satisfaction by providing them with efficient solutions and satisfactory results. This has made me capable of handling any part of a project with ease and now I am a confident full stack developer who can work with customers to identify and deploy solutions. ',
        subBody: "I am Kunj Patel, a full stack developer from India. I grew up in Gujarat, a western region of the country. Computers and Technology have always been a subject of interest since childhood and I decided to pursue it as a  profession by gaining a bachelor's degree in computer science and engineering. To put my learned skills and knowledge into practice I worked with one small-scale tech company for two years. A desire of exploring more aspects of this field accrued while navigating through work life, which led me to do my post-graduation in ACE-mobile application development from Cégep de la Gaspésie et des Îles, Montreal, QC Canada.",
        Education: [
            {
                year: '2014-17',
                current: false,
        ...
        Experince: [
            {
                ...
                current: false,
                description: [
                    'Started as a junior developer, has developed skills to handle the client meetings and gather all the necessary resources to complete the tasks successfully with client satisfaction within a given time. Work my way up to the senior developer maintaining my team and the deadlines with up to more than  95% successful ratio. I had worked with various technologies such as ionic, angular, android, etc.'
                ],
            },
            {
                year: '2021-..',
...
class ContacmepageComponent {
    ...
    filedownload() {
        ...
        link.href = "assets/img/KunjPatel_Resume.pdf";
        link.click();
    }
    onSubmit() {
        this.submitted = true;
